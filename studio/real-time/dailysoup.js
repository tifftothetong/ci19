...
// run through an array of colours, div onclick will change the backgorundcolor to colours in the array 
//append function to divs 
// var colours = ["red","orange","yellow","lime","blue","#A54FCA"];
// var col;
...
// document.body.onclick = function() {changeBg()};


function red(){
  document.body.style.backgroundColor = "#c10d0d";
}
...
function yellow(){
  document.body.style.backgroundColor = "#fff900";
}
function green(){
  document.body.style.backgroundColor = "#91ff66";
}
function blue(){
  document.body.style.backgroundColor = "#1200ff";
}
function violet(){
